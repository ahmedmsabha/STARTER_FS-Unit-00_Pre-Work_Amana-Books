...
export const books: Book[] = [
  ...
  // Architecture Textbooks
  {
    id: '5',
    title:
      'Islamic Architecture: Geometry and Design Principles',
  ...
  // Added via assistant: Additional featured sample to verify flows
  {
    id: '46',
    title: 'Foundations of Data Visualization',
    author: 'Dr. Lina Al-Farisi',
    description:
      'Principles and practices for effective visual communication of data using modern tools and techniques.',
    price: 72.4,
    image: '/images/book6.jpg',
    isbn: '978-4678901234',
    genre: ['Computer Science', 'Data Visualization'],
    tags: ['Visualization', 'UX', 'Analytics'],
    datePublished: '2023-09-01',
    pages: 456,
    language: 'English',
    publisher: 'Al-Farisi Informatics',
    rating: 4.4,
    reviewCount: 11,
    inStock: true,
    featured: true,
